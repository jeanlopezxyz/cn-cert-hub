 ...
 * Fuzzy search algorithm with configurable thresholds and weights
 */
 ...
 */
export function calculateFuzzyScore(text: string, searchQuery: string): number {
...
/**
 * Get score threshold based on query length
 */
export function getScoreThreshold(queryLength: number): number {
